...
This repository contains a Jules PWA wrapper. To improve the user experience, Jules agents must follow these global notification rules whenever they have finished a task or require input.
